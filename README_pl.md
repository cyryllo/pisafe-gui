...
- **🔧 Narzędzia dysku** — sprawdź dowolny dysk poza napędami optycznymi (wykryty system, układ partycji, wolne miejsce); szybkie formatowanie (FAT32/exFAT/NTFS/ext4) jest aktywne tylko dla dysków USB/SD, tak samo zabezpieczone jak flashowanie
